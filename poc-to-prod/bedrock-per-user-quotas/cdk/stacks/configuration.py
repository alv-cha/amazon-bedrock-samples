"""Validated deployment configuration for the quota gateway stack."""
...
class DeploymentConfig:
    ...
    def from_node(cls, node: Node) -> "DeploymentConfig":
        ...
        if not 900 <= vended_ttl_seconds <= 43_200:
            raise ValueError(
                "vended_ttl_seconds must be between 900 (15 min) and 43200 "
                f"(12h, the STS AssumeRole limit); got {vended_ttl_seconds}"
            )
